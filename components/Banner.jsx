  ...
  return (
    <div className='flex flex-wrap my-10 bg-slate-200 h-[350px] justify-around' >
      ...
      <div className="picture flex space-x-2 m-auto">
        ...
        <Link href="/login"><button className="flex mx-auto text-white bg-black border-0 py-2 px-4 focus:outline-none hover:bg-white hover:text-black hover:border-2 hover:font-semibold rounded text-sm">Explore more</button></Link>
