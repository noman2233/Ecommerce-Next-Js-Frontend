...
const Products = ({ data }) => {
    ...
    <div className='flex align-middle justify-center flex-wrap'>
         {data.map((item,index)=>{
              ...
              <Link href={`/productpage/${item.id}`}  className=" h-48 flex align-middle justify-center rounded overflow-hidden" >
              ...
              <div className="mt-4 ">
                ...
                <h2 className="text-gray-900 text-center title-font text-lg font-medium">{item.title.slice(1,19)} </h2>
